...
class ConfigCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'prionbrute:config';
     ...
     * @var string
     */
    protected $description = 'Creates the configuration files for setting.';
    ...
    public function handle()
    {
        ...
        $this->line('');
        $this->info("Brute Config Creation.");
        $this->line('');
    ...
    {
        $base = "Setting config already exist.\nFollowing file was found: ";
